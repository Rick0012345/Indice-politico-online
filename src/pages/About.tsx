  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-extrabold text-slate-900">Sobre o Catálogo Político</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
        {[
          ...
          <div key={i} className="rounded-2xl border border-slate-200 p-6 bg-white hover:border-blue-200 transition-colors">
