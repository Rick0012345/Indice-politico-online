    ...
    <nav className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          <button className="hidden items-center gap-2 rounded-full bg-slate-100 px-4 py-2 text-sm font-medium text-slate-600 transition-colors hover:bg-slate-200 md:flex">
            <User size={18} />
            <span>Entrar</span>
          </button>
          <button
      ...
      {isMobileMenuOpen && (
        <div className="border-t border-slate-200 bg-white/95 px-4 py-4 shadow-sm md:hidden">
          <div className="flex flex-col gap-2">
            ...
            <button
              type="button"
              className="mt-2 flex items-center justify-center gap-2 rounded-2xl bg-slate-100 px-4 py-3 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-200"
            >
              <User size={18} />
              <span>Entrar</span>
            </button>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li>
                <Link to="/ranking" className="hover:text-blue-600">
                  Ranking Geral
                </Link>
              </li>
              <li>
                <Link to="/metodologia" className="hover:text-blue-600">
                  Metodologia
                </Link>
              </li>
              <li>
